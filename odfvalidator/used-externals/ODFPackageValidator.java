...
//				: m_aValidatorProvider.getValidator(aParentLogger.getOutputStream(), aVersion);
	...
	protected boolean validateMeta(Logger aParentLogger, String aEntryName, OdfVersion aVersion, boolean bIsRoot) throws IOException, ZipException, IllegalStateException, ODFValidatorException {
		Logger aLogger = new Logger(aEntryName, aParentLogger);
	...
	protected boolean validateMathML(Logger aParentLogger, String aEntryName, OdfVersion aVersion) throws IOException, ZipException, IllegalStateException, ODFValidatorException {
		Logger aLogger = new Logger(aEntryName, aParentLogger);
	...
	protected String getVersion(Logger aLogger) throws ODFValidatorException {
